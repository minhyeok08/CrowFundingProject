...
public class MakerpageController {
	...
	public String project_list(Model model, HttpSession session)
	{
		String id =(String)session.getAttribute("id");
...
//		System.out.println(list);
	...
	// 리워드 추가로 이동
	@GetMapping("makerpage/reward_insert_add.do")
	public String reward_insert_add(int wfno,Model model)
	{
		model.addAttribute("wfno",wfno);
		return "makerpage/reward_insert_add";
	}
	//리워드 등록
	...
	//리워드 추가 등록
	@PostMapping("makerpage/reward_insert_add_ok.do")
	public String reward_insert_add_ok(RewardVO vo)
	{
		dao.rewardInsertData(vo);
	...
	@GetMapping("makerpage/project_update_for_reward.do")
	public String project_update_for_reward(int wfno,Model model)
	{
		model.addAttribute("wfno",wfno);
		return "makerpage/project_update_for_reward";
	}
	@PostMapping("makerpage/project_update_for_reward_ok.do")
	public String project_update_for_reward_ok(FundVO vo,HttpSession session,HttpServletRequest request)
	{
		String path=request.getSession().getServletContext().getRealPath("/")+"Fundimages\\";
		path=path.replace("\\", File.separator);
		List<MultipartFile> list = vo.getFiles();
	...
	public String project_update_ok(FundVO vo,HttpSession session,HttpServletRequest request)
	{
		String path=request.getSession().getServletContext().getRealPath("/")+"Fundimages\\";
		path=path.replace("\\", File.separator);
		List<MultipartFile> list = vo.getFiles();
