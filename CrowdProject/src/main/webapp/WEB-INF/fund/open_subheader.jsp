...
<body>
	<div class="row">
		  <div class="button-container">
			<a href="../fund/open_detail.do?wfno=${ wfno }"><button class="bordered-button">스토리</button></a>
	        <a href="../fund/open_news.do?wfno=${ wfno }"><button class="bordered-button">새소식</button></a>
