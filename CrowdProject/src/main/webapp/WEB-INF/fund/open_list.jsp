					...
					<div class="wcate2">
						<div class="wcate3">
							<ul class="wcate4">
								...
								<li data-index="12"><button class="wbtn1" @click="categoryGetData(14)">
										<div class="wbtn2">
											<div class="wbtn3">
												<div class="wbtn4"
								...
								<li data-index="13"><button class="wbtn1" @click="categoryGetData(15)">
										<div class="wbtn2">
											<div class="wbtn3">
												<div class="wbtn4"
			...
			<div class="row">
				...
				<div class="col-md-4" v-for="vo in fund_list">
					<div class="thumbnail" style="width: 260px;">
						<a :href="'../fund/open_detail_before.do?wfno='+vo.wfno"> 
		...
		new Vue({
			...
			methods:{
				categoryGetData:function(fcno){
					axios.get("../fund/open_list_vue.do",{
						params:{
							fcno:fcno
						}
					}).then(response=>{
