	...
	<div class="adminContainer">
		<form method="post" action="../notice/insert_ok.do">
			<div class="form-group">
				...
				<input type="text" name="writer" class="form-control" id="writer" size="20">
			</div>
			<div class="form-group">
				<label class="form-label" for="subject">제목</label>
				<input type="text" name="subject" class="form-control" id="subject" size="50">
			</div>
			<div class="form-group">
				<label class="form-label" for="content">내용</label>
				<textarea rows="10" cols="52" name="content" class="form-control" id="content"></textarea>
			</div>
			<div class="form-group">
			...
			<div class="text-center">
				<input type="submit" value="글쓰기" class="btn btn-custom">
